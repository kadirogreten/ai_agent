...
/**
 * Çalıştırma sihirbazı — Domain → Persona → Playbook → Topic → Çalıştır.
 * Mimari önemi: persona seçilince behaviors önizlemesi gösterilir;
 * playbook listesi persona'nın risk tavanına göre otomatik filtrelenir.
 * run_requests'e mode=run + answers_json={playbookId, topic, persona} yazılır;
 * worker 2dk içinde claim edip dotnet'i tetikler.
 */
