...
public static class HelpText
{
    public static string Build()
    {
        ...
        sb.AppendLine("  run --playbook <id> [--topic <text>] [--persona <id>] [--risk R0|R1|R2|R3] [--allowHighRisk true|false] [--dryRun true|false] [--web true|false] [--domainPack <id>] [--model <name>] [--facts true|false] [--contrarian true|false]");
        sb.AppendLine("  bundle --domainPack <id> [--id <bundleId>] [--topic <text>] [--risk R0|R1|R2|R3] [--allowHighRisk true|false] [--web true|false] [--model <name>] [--dryRun true|false] [--contrarian true|false]");
        sb.AppendLine("  ceo --domainPack <id> --request <text> [--model <name>] [--dryRun true|false]");
        sb.AppendLine("  ceo-iterate --domainPack <id> --request <text> --answers <json> [--model <name>] [--dryRun true|false]");
